 ...
 */
$config['DEBUG'] = 0;
$config['SALT'] = '1PLEASEMAKEMESOMETHINGRANDOM';
$config['SALTY'] = '1THISSHOULDALSOBERRAANNDDOOM';
...
$config['db']['user'] = 'root';
$config['db']['pass'] = 'MhxzKhl';
$config['db']['port'] = 3306;
$config['db']['name'] = 'rbc_mpos';
...
$config['wallet']['host'] = 'localhost:22883';
$config['wallet']['username'] = 'rambocoinrpc';
$config['wallet']['password'] = 'AuQo8wRnYKdQ5npW8WukecC2pGXEvhKwwSdZkTBGe72x';
 ...
 **/
$config['gettingstarted']['coinname'] = 'rambocoin';
...
$config['ap_threshold']['max'] = 2500000000;
